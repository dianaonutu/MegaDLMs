...
GPUS_PER_NODE=$GPUS_PER_NODE # todo: set to your own env value
NUM_NODES=$NUM_NODES # todo: set to your own env value
NODE_RANK=$NODE_RANK # todo: set to your own env value
MASTER_ADDR=$MASTER_ADDR # todo: set to your own env value
MASTER_PORT=$MASTER_PORT # todo: set to your own env value
...
train_data_prefix="$DATASETS_DIR/path/to/train/data/prefix"
valid_data_prefix="$DATASETS_DIR/path/to/valid/data/prefix"
